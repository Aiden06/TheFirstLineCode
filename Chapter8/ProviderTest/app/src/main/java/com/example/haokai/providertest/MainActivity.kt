package com.example.haokai.providertest
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addData.setOnClickListener {
            val uri = Uri.parse("content://com.example.haokai.databasetest.provider/book")
        ...
        updateData.setOnClickListener {
            bookId?.let {
                val uri = Uri.parse("content://com.example.haokai.databasetest.provider" +
                        "/book/$it")
